...
```{r cali, strip.white=TRUE, fig.cap="Probability of agrochemical product success in response to daily maximum temperatures on farms in California. High temperatures significantly impacted product performance (p < 0.001)."}
